...
{
	$cn=makeconnection();
	$s="delete from partners  where patid='" . $_POST["t1"] . "'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
{
$cn=makeconnection();
$s="select * from partners where patid='" .$_POST["t1"] ."'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
...
<tr><td class="lefttxt">Company Name</td><td><input type="text"  value="<?php if(isset($_POST["show"]))
{ echo $Companyname ;} ?> " name="t2" required /></td></tr>

<tr><td class="lefttxt">Old Pic</td><td><img src="partnerimages/<?php echo @$Pic; ?>" width="150px" 
height="100px" /></td></tr>
