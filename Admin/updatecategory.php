...
if(isset($_POST["sbmt"]))
{
	...
	mysqli_query($cn,$s);
	mysqli_close($cn);
	header ("location: updatecategory.php?note=Record saved");
}
?>
...
<tr><td class="lefttxt">Selected Category Name</td><td><select style="width:200px" name="t1" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Category Name</td><td><input style="width:200px" type="text" name="t2" required /></td></tr>
